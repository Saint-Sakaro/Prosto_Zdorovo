    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "partner_name",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Партнер"
                    ),
                ),
                (
                    "metadata",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_unique",
                    models.BooleanField(default=False, verbose_name="Уникальный"),
                ),
                (
                    "moderation_status",
                    models.CharField(
                ...
                (
                    "extracted_facts",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Извлеченные факты (LLM)"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transaction_type",
                    models.CharField(
                        choices=[("credit", "Начисление"), ("debit", "Списание")],
                        max_length=10,
                ...
                (
                    "balance_after",
                    models.IntegerField(verbose_name="Баланс после транзакции"),
                ),
                (
                    "metadata",
                    models.JSONField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="user_rewards",
                        to="gamification.rewardtransaction",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="gamificatio_latitud_be90f1_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="review",
            index=models.Index(
                ...
                name="gamificatio_moderat_5343f4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="review",
            index=models.Index(
                fields=["author", "created_at"], name="gamificatio_author__39052f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rewardtransaction",
            index=models.Index(
                fields=["user", "created_at"], name="gamificatio_user_id_ccb42d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="rewardtransaction",
            index=models.Index(
                fields=["reason", "created_at"], name="gamificatio_reason_729f47_idx"
            ),
        ),
