    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "marker_color",
                    models.CharField(
                        default="#FF0000", max_length=7, verbose_name="Цвет маркера"
                    ),
                ),
                (
                    "display_order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Название схемы"),
                ),
                (
                    "schema_json",
                    models.JSONField(default=dict, verbose_name="JSON схема анкеты"),
                ),
                (
                    "version",
                    models.CharField(
                        default="1.0", max_length=20, verbose_name="Версия схемы"
                    ),
                ),
                (
                    "generated_by_llm",
                    models.BooleanField(
                        default=False, verbose_name="Сгенерирована через LLM"
                    ),
                ),
                (
                    "llm_prompt",
                    models.TextField(blank=True, verbose_name="Промпт для LLM"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "working_hours",
                    models.TextField(blank=True, verbose_name="Время работы"),
                ),
                (
                    "is_geocoded",
                    models.BooleanField(default=False, verbose_name="Геокодирован"),
                ),
                (
                    "geocoded_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дата геокодирования"
                    ),
                ),
                (
                    "metadata",
                ...
                (
                    "form_data",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Данные анкеты"
                    ),
                ),
                (
                    "verified",
                ...
                (
                    "llm_verdict",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Вердикт LLM"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_calculated_at",
                    models.DateTimeField(
                        auto_now=True, verbose_name="Последний расчет"
                    ),
                ),
                (
                    "last_infra_calculation",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Последний расчет S_infra"
                    ),
                ),
                (
                    "last_social_calculation",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Последний расчет S_social"
                    ),
                ),
                (
                    "calculation_metadata",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Метаданные расчета"
                    ),
                ),
                (
                    "calculation_method",
                ...
                (
                    "metrics",
                    models.JSONField(blank=True, default=dict, verbose_name="Метрики"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "active_filters",
                    models.JSONField(default=list, verbose_name="Активные фильтры"),
                ),
                (
                    "health_index",
                    models.FloatField(
                ...
                (
                    "category_stats",
                    models.JSONField(
                        default=dict, verbose_name="Статистика по категориям"
                    ),
                ),
                (
                    "objects_count",
                ...
                (
                    "area_name",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="Название области"
                    ),
                ),
                (
                    "created_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="maps_areaan_analysi_18e4e7_idx",
                    ),
                    models.Index(
                        fields=["user", "created_at"],
                        name="maps_areaan_user_id_3aaae0_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            model_name="poi",
            index=models.Index(
                fields=["latitude", "longitude"], name="maps_poi_latitud_a01223_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="poi",
            index=models.Index(
                fields=["category", "is_active"], name="maps_poi_categor_ab2b8a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="poi",
            index=models.Index(
                fields=["is_active", "created_at"], name="maps_poi_is_acti_1539e9_idx"
            ),
        ),
    ]
